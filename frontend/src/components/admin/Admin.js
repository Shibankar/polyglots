...
import Shibankar from "../../images/avatars/Shibankar.jpeg";
import {CustomModal} from "../customModal/CustomModal";
import {PlayPronunciation} from "../playPronunciation/PlayPronunciation";
import {OverridePronunciation} from "../overridePronunciation/OverridePronunciation";
    ...
    return (
        ...
        <div className="user-header">
            <div className="user-img">
                <img src={Shibankar} alt="santhosh-profile" />
            </div>
            <div className="user-name">
                <div className="name">
                    <span>Welcome Shibankar[admin] </span>
                </div>
